...
namespace Gdd.Game.Engine.Content.Pipeline.Processors
{
    ...
    public class AnimatedModelProcessor : ModelProcessor
    {
        ...
        static Dictionary<string, AnimationClip> ProcessAnimations(
            AnimationContentDictionary animations, IList<BoneContent> bones, ContentProcessorContext context, String source)
        {            
        ...
        static AnimationClip ProcessAnimation(AnimationContent animation,
                                              Dictionary<string, int> boneMap, int keyframeStart, int keyframeEnd)
        {
