...
namespace Gdd.Game.Engine.Menu
{
    ...
    public class InGameMenu : Scenes.Scene
    {
        #region Constant(常量)

        // Rectangles used in pictures(图片所使用的矩形)
        static readonly Rectangle
            InGameMenuLogoRect = new Rectangle(0, 0, 512, 110),
            InGameMenuResumeRect = new Rectangle(0, 110, 512, 38),
            //            InGameMenuRestartRect = new Rectangle(0, 148, 512, 38),
            //            InGameMenuLoadRect = new Rectangle(0, 186, 512, 38),
            //            InGameMenuSaveRect = new Rectangle(0, 224, 512, 38),
            InGameMenuQuitRect = new Rectangle(0, 262, 512, 38);
        ...
        public InGameMenu(Microsoft.Xna.Framework.Game game)
            : base(game)
        {
            this.TopMost = true;
        ...
        protected override void LoadContent()
        {
            ...
            backgroundTexture = this.Game.Content.Load<Texture2D>("MenuContent\\InGameMenuBackground");
            menuTexture = this.Game.Content.Load<Texture2D>("MenuContent\\InGameMenu");
        ...
        public override void Draw(GameTime gameTime)
        {
            ...
            RenderSprite(menuTexture,
                    512 - InGameMenuLogoRect.Width / 2, 150, InGameMenuLogoRect);
            RenderSprite(menuTexture,
                    512 - InGameMenuResumeRect.Width / 2, 350, InGameMenuResumeRect,
                    currentMenuItem == 0 ? Color.Orange : Color.White);
            //   RenderSprite(menuTexture,
            //           512 - InGameMenuRestartRect.Width / 2, 350, InGameMenuRestartRect,
            //           currentMenuItem == 1 ? Color.Orange : Color.White);
            //   RenderSprite(menuTexture,
            //           512 - InGameMenuLoadRect.Width / 2, 400, InGameMenuLoadRect,
            //           currentMenuItem == 2 ? Color.Orange : Color.White);
            //   RenderSprite(menuTexture,
            //           512 - InGameMenuSaveRect.Width / 2, 450, InGameMenuSaveRect,
            //           currentMenuItem == 3 ? Color.Orange : Color.White);
            RenderSprite(menuTexture,
                    512 - InGameMenuQuitRect.Width / 2, 450, InGameMenuQuitRect,
                    currentMenuItem == 1 ? Color.Orange : Color.White);
