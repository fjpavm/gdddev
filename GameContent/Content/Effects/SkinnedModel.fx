...
// Slightly changed to fit the GDD game
//-----------------------------------------------------------------------------
#include "PointLights.fx"
...
VS_OUTPUT VertexShader(VS_INPUT input)
{
    ...
    float3 normal = normalize(mul(input.Normal, mul(position, World)));
  
	output.Lighting = GetPointLightColor(normal, output.Position);
